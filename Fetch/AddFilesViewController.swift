    ...
    func addTransfer() {
        ...
        if let file = torrent {
            ...
            Alamofire.upload(multipartFormData: { data in
                data.append(file, withName: "file", fileName: "", mimeType: "")
                data.append(parentId.data(using: String.Encoding.utf8)!, withName: "parent_id", mimeType: "")
            }, to: "https://upload.put.io/v2/files/upload?oauth_token=\(Putio.accessToken!)", method: .post, encodingCompletion: { encodingResult in
            ...
            var params: [String: Any] = ["oauth_token": "\(Putio.accessToken!)", "url": url, "extract": "true"]
