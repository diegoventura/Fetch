...
class TVShowCollectionViewController: UICollectionViewController, UICollectionViewDelegateFlowLayout, TVShowDelegate {
    ...
    override func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        ...
        if kind == UICollectionElementKindSectionHeader {
            ...
            let season = show.seasons.sorted(byProperty: "number")[indexPath.section]
    ...
    override func numberOfSections(in collectionView: UICollectionView) -> Int {
        return show.seasons.sorted(byProperty: "number").count
    }

    override func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return show.seasons.sorted(byProperty: "number")[section].episodes.sorted(byProperty: "episodeNo").count
    }
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let ep = show.seasons.sorted(byProperty: "number")[indexPath.section].episodes.sorted(byProperty: "episodeNo")[indexPath.item]
    ...
    override func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        if let file = show.seasons.sorted(byProperty: "number")[indexPath.section].episodes.sorted(byProperty: "episodeNo")[indexPath.item].file {
